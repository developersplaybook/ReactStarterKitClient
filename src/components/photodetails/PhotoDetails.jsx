                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <PhotoFrame>
                          <img src={`${apiAddress}/RandomHandler/Index/PhotoID=${photoId}/Size=L`} className="photo_198" style={{ border: '4px solid white', objectFit: 'contain', minHeight: '500px', maxHeight: '500px' }} alt={`PhotoID ${photoId}`} />
                        </PhotoFrame>
                        <p>
